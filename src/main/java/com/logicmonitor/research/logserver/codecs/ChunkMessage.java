...
import com.logicmonitor.research.logserver.message.ResolvableInetSocketAddress;
...
public class ChunkMessage {
     ...
     * @see ChunkMessage.Type
     */
    public ChunkMessage(final byte[] payload) {
        this(payload, null);
    }

    public ChunkMessage(final byte[] payload, ResolvableInetSocketAddress sourceAddress) {
