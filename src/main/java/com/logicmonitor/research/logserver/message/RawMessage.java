...
import com.logicmonitor.research.logserver.node.NodeId;
...
import static com.logicmonitor.research.logserver.message.JournalMessages.JournalMessage;
...
public class RawMessage implements Serializable {
    ...
    private transient final JournalMessages.JournalMessage.Builder msgBuilder;
    ...
    public RawMessage(JournalMessages.JournalMessage journalMessage, long journalOffset) {
        ...
        msgBuilder = JournalMessages.JournalMessage.newBuilder(journalMessage);
    ...
    public static RawMessage decode(final byte[] buffer, final long journalOffset) {
        try {
            final JournalMessages.JournalMessage journalMessage = JournalMessages.JournalMessage.parseFrom(buffer);
    ...
    public byte[] encode() {
        try {
            ...
            final JournalMessages.JournalMessage journalMessage = msgBuilder.build();
    ...
    public String toStringUtf8() {
        return msgBuilder.getPayload().toStringUtf8();
    }
